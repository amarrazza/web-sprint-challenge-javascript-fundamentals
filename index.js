...
// The nested function is able to access the internal variable because it is inheriting the variables used in the parent function.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerAnimals = array.map(item => item["animal_name"].toLowerCase());
    return lowerAnimals;
  }
  ...
  */
  ...
  function USApop(array){
    const animalPop = array.reduce((accumulator, item) => {
...
CuboidMaker.prototype.volume = function(){
  return `${this.length} is the length`
}
